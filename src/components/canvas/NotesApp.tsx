...
const NotesApp = ({ notes, isLoading, onNoteSelect, onCreateNote }: NotesAppProps) => {
            ...
            <div className="grid gap-3 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
              {filteredNotes.map((note) => (
                <button
                  ...
                  className="text-left p-4 rounded-xl border border-border bg-card hover:bg-muted/50 hover:border-primary/30 active:scale-[0.98] transition-all group"
                >
